...
export default function CategoriesManager() {
  ...
  const TABS = settings?.tabs ?? ['Main', 'Drinks'];
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setValidationError('');
    if (!houseId) { setValidationError('House not loaded'); return; }
  ...
  const isLoading = categories === undefined || house === undefined || settings === undefined;
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-secondary text-sm mb-6">Are you sure you want to delete this category?</p>
